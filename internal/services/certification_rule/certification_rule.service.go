...
func NewCertificationRuleService(repo *repositories_certificationrule.CertificationRuleRepository) *CertificationRuleService {
	return &CertificationRuleService{certificationRuleRepo: repo}
}
