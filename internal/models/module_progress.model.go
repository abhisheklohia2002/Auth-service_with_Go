...
type ModuleProgress struct {
	...
	VideoDurationSeconds int        `gorm:"default:0" json:"video_duration_seconds"`
	VideoWatchedSeconds  int        `gorm:"default:0" json:"video_watched_seconds"`
	VideoWatchedPercent  int        `gorm:"default:0" json:"video_watched_percent"`
	VideoCompletedAt     *time.Time `json:"video_completed_at"`
